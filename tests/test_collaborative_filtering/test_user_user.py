...
from recsys.collaborative_filtering import UserUserCollaborativeFiltering
...
class TestUserUserCollaborativeFiltering(object):
    ...
    def test___init__RaisesSimilarityMethodNotAvailable(self):
        with pytest.raises(SimilarityMethodNotAvailable):
            _ = UserUserCollaborativeFiltering(
                ...
                minimum_common_items=self._MINIMUM_COMMON_ITEMS,
                K_top_similar_users=self._TOP_SIMILAR_USERS,
            )
